...
void Imprimir(register const char *cadena,unsigned char barras)
{
	...
	if(barras)
	{
		...
		PutCh('h');
		PutCh(0x50);	// altura del codigo = 50 dots
...
void Imprimir_Ticket(unsigned char *patente,unsigned char *hora)
{
	...
	Inicializo_Impresion(0,0);
	PutStr("PLAYA DE ESTACIONAMIENTO\n");
	PutStr("de MARIANO DEVILLE\n");
	PutStr("CUIT: 20-25080557-9\n");
	PutStr("IIB: 218115888\n");
	PutStr("MUN: 135425 Inicio 05/01/04\n");
	...
	PutStr("Esta empresa no se responsabiliza el por robo, hurto,\n");
